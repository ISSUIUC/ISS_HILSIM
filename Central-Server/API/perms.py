...
def get_team_membership():
    ...
    x = requests.get(url=url,
                     headers={"Accept": "application/vnd.github+json", 'Authorization':"Bearer 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", "Content-Type": "text/html; charset=utf-8", "X-GitHub-Api-Version":"2022-11-28"})
