...
class CommunicationChannel(ABC):
    ...
    def write(self, data: str) -> None:
        ...
        raise NotImplementedError(
            "This communication channel's 'write' method has not been defined")

    @abstractmethod
    def read(self) -> str:
        """Reads all of the data from the channel"""
        raise NotImplementedError(
            "This communication channel's 'read' method has not been defined")

    @abstractmethod
    def waiting_in(self) -> bool:
        """Returns whether or not this communication channel has data in the input buffer"""
        raise NotImplementedError(
            "This communication channel's 'waiting_in' method has not been defined")

    @abstractmethod
    def waiting_out(self) -> bool:
        """Returns whether or not this communication channel has data in the output buffer"""
        raise NotImplementedError(
            "This communication channel's 'waiting_out' method has not been defined")

    @abstractmethod
    def open(self) -> None:
        """Opens the channel if it is closed"""
        raise NotImplementedError(
            "This communication channel's 'open' method has not been defined")

    @abstractmethod
    def close(self) -> None:
        """Closes the channel if it is open"""
        raise NotImplementedError(
            "This communication channel's 'close' method has not been defined")
