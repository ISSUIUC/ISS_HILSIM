...
class AvionicsInterface(ABC):
    ...
    def handle_init(self) -> None:
        ...
        raise NotImplementedError(
            "AvionicsInterface.handle_init method not implemented")
    ...
    def power_cycle(self) -> bool:
        ...
        raise NotImplementedError(
            "AvionicsInterface.HilsimRun.power_cycle method not implemented")
...
class HilsimRunInterface(ABC):
    ...
    def __init__(
            ...
            av_interface: AvionicsInterface,
            raw_csv: str,
            job: pkt.JobData) -> None:
    ...
    def step(self, dt: float) -> tuple[bool, bool, str]:
        ...
        """
        raise NotImplementedError(
            "AvionicsInterface.HilsimRun.step method not implemented")
